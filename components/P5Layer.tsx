      ...
      const sketch = (p: any) => {
        ...
        class Snow {
          ...
          constructor(p: any) {
            ...
            this.pos = this.p.createVector(this.p.random(this.p.width), this.p.random(-this.p.height, 0));

            this.vel = this.p.createVector(this.p.random(-1, 1), this.p.random(1, 3));
        ...
        class Rain {
          ...
          constructor(p: any) {
            ...
            this.y = this.p.random(-this.p.height, 0);

            this.l = this.p.random(10, 20);

            this.s = this.p.random(10, 20);
          ...
          update() {
            ...
            if (this.y > this.p.height) this.y = this.p.random(-20, 0);
        ...
        class Storm {
          ...
          update() {
            ...
            if (this.y > this.p.height) { this.y = -10; this.x = this.p.random(this.p.width); }
        ...
        class Sunny {
          ...
          constructor(p: any) {
            ...
            this.v = this.p.createVector(this.p.random(-0.5, 0.5), this.p.random(-0.5, 0.5));

            this.a = this.p.random(255);
          ...
          show() {
            ...
            this.p.fill(200, 206, 212, this.p.sin(this.p.frameCount * 0.02) * 100 + 100);

            this.p.circle(this.pos.x, this.pos.y, this.p.random(1, 3));
        ...
        class Wind {
          ...
          constructor(p: any) {
            ...
            this.x = this.p.random(-200, this.p.width);

            this.y = this.p.random(this.p.height);

            this.offset = this.p.random(1000);
          ...
          show() {
            ...
            for(let i=0; i<10; i++) {
              ...
              let ny = this.y + this.p.noise(this.offset + i * 0.1) * 50;
        ...
        class Star {
          ...
          show() {
            ...
            let sx = this.p.map(this.x / this.z, 0, 1, 0, this.p.width) + this.p.width / 2;

            let sy = this.p.map(this.y / this.z, 0, 1, 0, this.p.height) + this.p.height / 2;
